...
[Here's my LinkedIn](https://www.linkedin.com/in/thomas-figg-492497328/)

I'm currently looking for staff or principal level roles, ideally with a DBA or backend-ish flavour, and preferrably as part of a small, product-focused, remote team. Although I live in the UK, I usually work during American timezones. 
...
If you aren't a third party recruiter, email me at thomas.figg at gmail.com.
...
## Staff Engineer at Loadsure (2024-2025)

Brought in to help migrate a legacy application onto more modern infrastructure. It involved a lot of reverse engineering, and working around limitations of Google Firestore. The project itself was an "accidental monolith", split across various services and stores across the platform, and driving the technical and architectural changes needed to bring it back up to a healthy state.

The most notable side project: building tooling to handle migrating from seven repositories to one, while preserving work in branches and pull requests, and incrementally updating the monorepo until the migration was complete.

Ultimately, the company failed to secure further investment and the whole UK office was made redundant, along with US and Columbian teams.

## Contractor at Hedge Video (2023)

Short term contract to build out a background processing system used to manage transfers, built atop a kubernetes cluster. The company mainly produced desktop software, and hired me to build something far more robust than a message broker and hopeful thinking.

After the software reached public beta, there wasn't really any other database work, backend work, or more operational work to move onto, so the contract came to a close.
...
- 2009-2011, Cloudsoft: A Cloud Services startup. Java. OSGi. Some AWS, Some Groovy too. 

- 2008-2009, Skyscanner: Replacing a JScript/VB6/XSLT driven web scraping process with python. Still in use today, but the real impact was being able to write code without editing production systems. We built CI/CD systems out of SVN, Rpm Packages, and a lot of bash script.
